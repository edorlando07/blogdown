...
### Solution Statement
This tutorial shows you some of the methods used to create these types of algorithms.  In the example presented, we utilized the The Rolling Stones song "Gimme Shelter" to produce the playlist.
...
Below we are passing the artist/track name into the model to produce a recommended playlist of 10 songs.  Some songs recommended include Jimi Hendrix's "All Along the Watchtower" as well as The Doors' "Light My Fire".  For the full list of recommendations, please see the list below.  
```{r}
