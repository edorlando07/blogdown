...
The goal for this project is to create a model that will produce a recommended playlist of 10 songs using 1 favorite song as an input.  In a few weeks, I will build a Shiny application that will allow anyone to also populate recommended playlists based on their individual tastes.
