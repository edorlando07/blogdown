...
What was great about this recommendation was that it introduced me to a couple songs I have never heard before that were pretty solid.  In addition, it offered some songs I know, recognize, and like as well.  Finally, there were a few songs that I did not particaully enjoy.  
...
Although models 2-4 showed a more promising ROC curve, the **arules_model_01** was selected since it produced the most results/recommendations.  In other words, arules_model_01 produced 10 song recommendations, while the other models stopped short of 10 songs.  The other algorithms fall short of the 10 song goal either because the support or confidence levels were set too high.
