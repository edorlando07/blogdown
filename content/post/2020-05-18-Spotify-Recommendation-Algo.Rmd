...
### Recognition & Credit
This article and its contents were heavily influenced by Matt Dancho's Learning Labs: Session #11. For more about Learning Labs Pro, please click [here](<https://university.business-science.io/p/learning-labs-pro>).  The application can be viewed by clicking the link below.
...
### Solution Statement
This tutorial shows you some of the methods used to create these types of algorithms.  In the example presented, we utilized one of my favorite songs by **The Rolling Stones** called *Gimme Shelter* to produce the following playlist.  In order to create your own playlist, click **[here](<https://edorlando82.shinyapps.io/Spotify_Shiny_App/>)** for the Shiny app.
...
### Conclusion
Although the final product did not produce a fully scalable application due to the server constraints, the application does provide some fun interactivity which allows viewers the chance to see how the algorithm influences their playlists.  
