...
The goal for this project is to create a model that will produce a recommended playlist of 10 songs based on songs that I already enjoy.  In a few weeks, I will also have a Shiny application that will allow anyone to also populate recommended playlists based on their individual tastes.
...
### Next steps
In the next few weeks, I plan to create a Shiny app which will allow you to enter your favorite song and receive a customized recommended playlist based on your tastes.  For questions or comments about this article, please send me a message on [LinkedIn](<https://www.linkedin.com/in/edorlando07/>).
